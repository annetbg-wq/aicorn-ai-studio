...
export const SKELETON_REGISTRY: Record<SkeletonId, SkeletonMeta> = {
  ...
  'social-community': {
    ...
    description: 'Feed, explore, create post, notifications, user profiles.',
    tags: ['social', 'community', 'feed', 'posts', 'follow', 'notifications'],
    navigation: 'bottom-tabs',
    deltaFiles: [],
    lockedPrefixes: [],
    providedComponents: [],
  ...
  'productivity-tool': {
    ...
    description: 'Kanban board, list view, item detail sheet, command palette.',
    tags: ['productivity', 'kanban', 'task', 'notes', 'tool', 'workspace', 'todos'],
    navigation: 'sidebar',
    deltaFiles: [],
    lockedPrefixes: [],
    providedComponents: [],
  ...
  'ecommerce': {
    ...
    description: 'Product grid, detail, cart sheet, checkout wizard, account.',
    tags: ['ecommerce', 'shop', 'store', 'marketplace', 'cart', 'checkout', 'product'],
    navigation: 'top-nav',
    deltaFiles: [],
    lockedPrefixes: [],
    providedComponents: [],
