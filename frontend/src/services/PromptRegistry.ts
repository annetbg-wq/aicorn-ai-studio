...
Правила:
- Только вопросы специфичные для данного проекта — никаких шаблонных вопросов
- Каждый вопрос — конкретная развилка с 2-4 вариантами ответа
- Первый вариант всегда самый продвинутый/полнофункциональный
