...
const TABS: Tab[] = ['overview', 'sources', 'themes', 'components', 'variants'];
...
<<<<<<< HEAD
        ...
        {selectedVariantObj && selectedColorFamilyObj && (
          <LiveVisualPreview
            skeletonId={selectedSkeleton}
...
function makePreviewTheme(variant: NormalizedVisualVariant | null, colorFamily: NormalizedColorFamily | null): PreviewTheme {
  ...
  const vars: React.CSSProperties & Record<string, string | number> = {
    '--vb-bg': cssColorFromToken(tokens.background),
    '--vb-fg': cssColorFromToken(tokens.foreground),
    '--vb-muted': cssColorFromToken(tokens.muted),
    '--vb-muted-fg': cssColorFromToken(tokens.foreground),
    '--vb-card': cssColorFromToken(tokens.card),
    '--vb-primary': cssColorFromToken(tokens.primary),
    '--vb-secondary': cssColorFromToken(tokens.secondary),
    '--vb-accent': cssColorFromToken(tokens.accent),
    '--vb-border': cssColorFromToken(tokens.border),
  ...
  return {
    ...
    elevation: elevationFromVariant(variant),
  };
}
