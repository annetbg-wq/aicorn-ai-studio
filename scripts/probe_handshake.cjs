// Synthetic handshake probe: open preview-app, rewrite __build_id.ts via studio's
// /__write_preview middleware, assert preview-app posts preview-mounted with the
...
(async () => {
  ...
  // 1. Load preview-app in the iframe and read its initial buildId
  ...
  // 3. Wait up to 10 s for the preview-app to log
