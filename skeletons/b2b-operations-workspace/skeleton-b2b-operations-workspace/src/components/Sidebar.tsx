...
export function Sidebar({ activeRoute, onChange }: { activeRoute: string; onChange: (route: string) => void }) {
  return <aside className="sidebar">
    <div className="sidebar-brand"><div className="logo-mark">Op</div><div><strong>B2B Operations Workspace</strong><p className="subtitle" style={{ margin: 0 }}>Skeleton shell</p></div></div>
